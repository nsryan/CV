...
\nobibliography{cv}
    ...
    \section{\mysidestyle Objective}
        ...
        Dynamic professional with a strong background in nuclear energy systems, advanced reactors, energy policy, and strategic operations. Experience in leading research and organizational teams, managing complex projects, and advancing nuclear energy policy.
                %
    %__________________________________________________________________________________________________________________
    % Computer Skills
    \section{\mysidestyle Key\\Skills}
        ...
        \textbf{Technical Tools} Word, Powerpoint, Outlook, Excel, Python, PyTorch, Mathematica, SQL, Sphinx, Git, C++.\vspace{1mm}
    %__________________________________________________________________________________________________________________
    % Education
    ...
    \begin{itemize}
        ...
        \item Contributed to Illinois Hydrogen Hub modeling, aiding in securing federal funding for regional clean energy initiatives.
    \end{itemize}
    ...
    \begin{itemize}
        \item Integrated versatile enrichment capabilities into the Cyclus simulator to support non-equilibrium reactor designs.
        \item Engaged with leading experts to refine methodologies for advanced nuclear systems and fuel cycle transitions.
    \end{itemize}
...
%__________________________________________________________________________________________________________________
    ...
    \begin{itemize}
        \item Developed a plenary about transitioning former coal and natural gas communities to nuclear communities.
