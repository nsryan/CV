...
\nobibliography{cv}
    ...
    \section{\mysidestyle Research\\Interests}
                ...
                energy system modeling, environmental justice, decommissioning, and
    ...
    \textbf{University of Illinois at Urbana-Champaign}, Urbana, IL\\
                ...
                \textsl{Advanced Reactors and Fuel Cycles group}\\
                In my capacity as a researcher, my focus has been on energy system modeling and analysis for non-energy applications of nuclear power plants and nuclear fuel cycle analysis of transition scenarios for advanced TRISO-fueled reactors.
...
%    \end{graytext}
    ...
    \textbf{Delegate}, Nuclear Engineering Student Delegation (NESD) \hfill \textbf{2023}\vspace{.5mm}\\%
    On NESD I will work to develop a policy statement for nuclear science research and education funding. We will then communicate this statement with a variety of NGO and elected representatives. \\
    ...
    The Young Professionals Congress is an embedded topical meeting focused on young professional's issues and concerns in nuclear science. In my capacity on YPC I developed a plenary about equitable transitions for former coal and natural gas communities in addition to more administrative efforts. \\
    \textbf{Public Relations Officer}, U. Illinois ANS student section  \hfill \textbf{2020--2022}\vspace{.5mm}\\%
    In my capacity as PR officer, I coordinated efforts to introduce and pass two pieces of clean energy legislation in the state of Illinois. In 2021 I coordinated phone banking, letter writing, and virtual meeting campaigns in support of what was the Climate Union Jobs Act which became the Climate and Equitable Jobs Act before it was signed into law. Recently, I worked to support the end to our moratorium on new nuclear energy projects in Illinois.\\
    ...
    \textbf{ANS}, Social Media for Local and Student Section Members Webinar \emph{Panel} \hfill\textbf{August 3, 2023}\\
