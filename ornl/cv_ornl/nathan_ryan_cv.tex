...
\nobibliography{cv}
    ...
    \section{\mysidestyle Research\\Interests}
                Nuclear fuel cycle simulation and analysis, geographical information systems, spatial modeling, energy regulation, nuclear reactor modeling, monte carlo methods, hydrogen fuel, energy system modeling, advanced reactor simulation, multi-objective optimization, and scientific computation.
                %
     %__________________________________________________________________________________________________________________
    % Computer Skills
    ...
    \textsc{Nuclear, Plasma, and Radiological Engineering}\vspace{1mm}
    \begin{list2}
        \item Title: LEU+ to HALEU transitions in advanced reactor fuel cycles
        \item Advisors:  Prof. Kathryn Huff, Prof. Madicken Munk
    \end{list2}\vspace{-1.5mm}
    ...
    \textbf{Oak Ridge National Laboratory}, Oak Ridge, TN\\
                ...
                Research and Test Reactor Physics Group\\\\
...
%    \end{graytext}
    ...
    \section{\mysidestyle Departmental\\Service}
                \textbf{Committee Member}, Diversity, Equity, and Inclusion Committee \hfill \textbf{2022 -- 2024}\vspace{.5mm}\\%
