...
\nobibliography{../cv}
    ...
    Nuclear Fuel Cycle and Advanced Reactor Analyst \hfill mobile: (708) 567-0002 \vspace{0mm}\\\vspace{0mm}%
        \textsl{Oak Ridge National Laboratory}
        \hfill e-mail: \href{mailto:ryanns@ornl.gov}{ryanns@ornl.gov}       \vspace{0mm}\\\vspace{0mm}%
    \textsl{Nuclear Energy and Fuel Cycle Division}
        \hfill website: \href{https://nsryan.github.io}{nsryan.github.io}     \vspace{0mm}\\\vspace{-4mm}%
    ...
    \section{\mysidestyle Research\\Interests}
                Nuclear fuel cycle simulation and analysis, geographical information systems, spatial modeling, energy regulation, supply chain analysis, nuclear energy policy, hydrogen fuel, energy system modeling, advanced reactor multiphysics, multi-objective optimization, and scientific computation.
                %
    %__________________________________________________________________________________________________________________
    % Research Experience
    \section{\mysidestyle Research\\Experience}
    \textbf{Oak Ridge National Laboratory}, Oak Ridge, TN\\
                \textsl{Research Scientist,} \hfill \textbf{June 2025 -- Present}\\
                \textsl{Graduate Summer Research Assistant,} \hfill \textbf{June 2024 -- Aug 2024}\\
                \textsl{Reactor and Nuclear Fuel Cycle Analysis Group}\\\\
    \textbf{University of Illinois at Urbana-Champaign}, Urbana, IL\\
                \textsl{Research Assistant, Nuclear Plasma and Radiological Engineering} \hfill \textbf{Aug 2022 -- May 2025}\\
    ...
    \textbf{University of Illinois Urbana-Champaign},\hfill\textbf{Aug 2022 -- May 2025}\\
    \textsc{Nuclear, Plasma, and Radiological Engineering}\vspace{-2mm}
    \section{\mysidestyle BS}
    \textbf{University of Illinois Urbana-Champaign},\hfill\textbf{Aug 2019 -- Aug 2022}\\
    \textsc{Engineering Physics}\vspace{-3mm}
...
%    \end{graytext}
    ...
    \begin{bibenum}
         \item \bibentry{ryan_2025}
    \end{bibenum}
    %__________________________________________________________________________________________________________________
    % Opinion Pieces
    \section{\mysidestyle Opinion\\Pieces}
    \begin{bibenum}
    ...
    \textbf{ORNL Research Symposium}, Updates to time, power, and deployment in,  \hfill\textbf{March 27, 2025}\\
    advanced reactor fuel cycle modeling, \emph{Speaker}.\\
    \textbf{ANS U. Illinois}, Presenting at a Conference, \emph{Speaker}.  \hfill\textbf{March 10, 2025}\\
    \textbf{ANS GL-Chicago}, Cyclus, LEU+, and HALEU fuel cycles, \emph{Presenter}.  \hfill\textbf{January 30, 2025}\\
    \textbf{ANS U. Illinois}, Perfecting a Conference Abstract, \emph{Speaker}.  \hfill\textbf{Dec 9, 2024}\\
    \textbf{ANS U. Illinois}, How to Present at a Conference, \emph{Speaker}.  \hfill\textbf{March 13, 2023}\\
    \textbf{ANS U. Illinois}, How to Create a Conference Abstract, \emph{Speaker}.  \hfill\textbf{Jan 23, 2023}\\
    \textbf{U. Illinois}, Physics and Astronomy Convocation, \emph{Speaker}.  \hfill\textbf{May 15, 2022}\\
    \textbf{Tinley Park High School}, Introduction to Nuclear Science \& Careers, \emph{Speaker}.  \hfill\textbf{Jan 17, 2020}\\
    \textbf{TEDxYouth}, Evolutionary Anthropology and Youth in Science, \emph{Speaker}.\hfill\textbf{Feb 15, 2019}\\

    %__________________________________________________________________________________________________________________
    % Invited Talks
    \section{\mysidestyle Panels \&\\Workshops}

    \textbf{ANS Midwest}, Attending your First Conference, \emph{Panelist}.  \hfill\textbf{November 9, 2024}\\
    \textbf{ANS Midwest}, Nuclear Outreach with Social Media, \emph{Workshop Lead}.  \hfill\textbf{November 9, 2024}\\
    \textbf{Institute for Genomic Biology}, Boundaries in Graduate School, \emph{Panelist}. \hfill \textbf{Aug 24, 2023}\\
    \textbf{ANS}, Social Media for Local and Student Section Members Webinar, \emph{Panelist}. \hfill\textbf{Aug 3, 2023}\\
    \textbf{Memphis Rise Academy}, Careers in Nuclear, \emph{Panelist}. \hfill\textbf{May 31, 2023}\\
    \textbf{U. Tennessee, Knoxville}, Navigating Conversations with Advisors,  \hfill\textbf{April 14, 2023}\\
    Managers, and Supervisors, \emph{Moderator}.\\
    ...
    \textbf{Computational Resource Access Network}, Board of Directors \hfill \textbf{2022 -- Present}\\
    Introduction to Python, Numerical Methods, Parallel Programming, and Best Practices \vspace{2mm}\\\
    \textbf{Worldwide Youth in Science and Engineering}, Urbana, IL \hfill \textbf{July 2022, 2023}\\
    ...
    \section{\mysidestyle Graduate\\Interns}
    \makebox[0.3\textwidth][l]{\textsc{\underline{Meghan Krieg}}}
    \makebox[0.2\textwidth][l]{\textsc{\underline{PhD Student - Summer 2026}}}
    \hfill\textsc{\underline{Summer Advisor}}\\
    ...
    \section{\mysidestyle Scientific\\Computing\\Skills}
        \textbf{Coding Languages} \hfill Bash, C++, Python, HTML, CSS, \LaTeX, BibTeX, XML \vspace{.5mm}\\%
        \textbf{Build Systems} \hfill make, CMake, Docker\vspace{.5mm}\\%
        \textbf{Databases} \hfill SQL, SQLite, JSON, CSV\vspace{.5mm}\\%
        \textbf{Test Frameworks} \hfill PyTest\vspace{.5mm}\\%
        \textbf{Version Control} \hfill git\vspace{.5mm}\\%
        \textbf{Applications} \hfill Sphinx, Mathematica, PyTorch, Word, Excel, Powerpoint, cPanel \\
        \textbf{Nuclear Codes} \hfill \cyclus, Serpent, SCALE\vspace{.5mm}%
    %__________________________________________________________________________________________________________________
    ...
    \textbf{Member}, Student Sections Committee, ANS \hfill \textbf{2023 -- 2026}\vspace{.5mm}\\%
    \textbf{Delegate}, Nuclear Engineering Student Delegation \hfill \textbf{2023, 2024}\vspace{.5mm}\\%
    \textbf{Vice Chair}, Student Sections Committee, ANS \hfill \textbf{2023 -- 2025}\vspace{.5mm}\\%
    \textbf{Subcommittee Chair}, Student and Young Member Liaison Committee, ANS \hfill \textbf{2023 -- 2025}\vspace{.5mm}\\%
    \textbf{Subcommittee Chair}, Student Conference Committee, ANS \hfill \textbf{2022 -- 2025}\vspace{.5mm}\\%
    ...
    \textbf{Member}, ANS CARES, ANS \hfill \textbf{2022 -- Present}\vspace{.5mm}\\%
    ...
    \textbf{Media Chair}, 2022 ANS Student Conference \hfill \textbf{2019 -- 2022}\vspace{.5mm}\\%
    %__________________________________________________________________________________________________________________
    \section{\mysidestyle Departmental\\Service}
                \textbf{Committee Member}, Diversity, Equity, and Inclusion Committee \hfill \textbf{2022 -- 2025}\vspace{.5mm}\\%
                \textbf{Committee Chair}, Graduate Student Advisory Committee \hfill \textbf{2022 -- 2023}\vspace{.5mm}\\%
                \textbf{Camp Advisor}, Worldwide Youth in Science and Engineering \hfill \textbf{2022 -- 2024}\vspace{.5mm}\\%
